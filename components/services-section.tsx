...
export function ServicesSection() {
  const services = [
    {
      icon: Trash2,
      title: "Junk Removal in Dallas, Red Oak & DFW",
      desc: "Fast, affordable junk removal services for homes & businesses across Dallas, TX.",
    },
    {
      icon: Building2,
      title: "Dumpster Rental in Dallas, Red Oak & DFW",
      desc: "Convenient dumpster drop-off & pickup services for residential & commercial projects.",
    },
    {
      icon: Zap,
      title: "Skid Steer Work in Dallas, Red Oak & DFW",
      desc: "Heavy-duty skid steer services for land clearing, debris removal & construction support.",
    },
    {
      icon: Hammer,
      title: "Demolition in Dallas, Red Oak & DFW",
      desc: "Safe & efficient interior/exterior demolition services in Dallas & nearby areas.",
    },
  ]
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-white mb-4">
            Dallas <span className="text-neon">Junk Removal & Services</span>
          </h2>
          <p className="text-xl text-gray-300">
            Same-day junk hauling, dumpster rental, demolition & skid steer services in Dallas, TX.
          </p>
        </div>
