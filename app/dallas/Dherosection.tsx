...
export function HeroSectionDallas() {
    ...
    <section className="relative overflow-hidden h-auto lg:h-screen py-8 md:py-16">
      ...
      <div className="container mx-auto px-4 sm:px-6 h-full flex flex-col justify-center">
        <div className="grid lg:grid-cols-2 gap-8 items-center w-full">
          ...
          <div className="space-y-4 relative z-10">
            <h1 className="text-2xl sm:text-4xl lg:text-5xl font-extrabold leading-tight">
              Affordable <span className="text-neon">Junk Removal Services</span> in Dallas, TX
            </h1>
            <p className="text-sm sm:text-base lg:text-lg text-gray-300 max-w-md leading-relaxed">
             Same-day junk removal in Dallas, TX with affordable demolition, dumpster rental, and skid steer services. We provide fast, eco-friendly cleanouts for Dallas homes and businesses. Call 214-258-3511 for a free quote!
            </p>
          </div>
        ...
        <div className="flex justify-center mt-8 relative z-10">
          ...
          >
            <a href="tel:2142583511">Urgent Junk Removal Service in Dallas, TX</a>
          </Button>
        </div>
      </div>
    </section>
