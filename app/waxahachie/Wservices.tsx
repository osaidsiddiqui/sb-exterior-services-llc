...
export function ServicesSection() {
  const services = [
    {
      icon: Trash2,
      title: "Junk Removal in Waxahachie",
      desc: "Fast, affordable junk removal services for homes & businesses across Waxahachie, TX.",
    },
    {
      icon: Building2,
      title: "Dumpster Rental in Waxahachie",
      desc: "Convenient dumpster drop-off & pickup services for residential & commercial projects.",
    },
    {
      icon: Zap,
      title: "Skid Steer Work in Waxahachie",
      desc: "Heavy-duty skid steer services for land clearing, debris removal & construction support.",
    },
    {
      icon: Hammer,
      title: "Demolition in Waxahachie",
      desc: "Safe & efficient interior/exterior demolition services in Waxahachie & nearby areas.",
    },
  ]
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-white mb-4">
            Waxahachie <span className="text-neon">Junk Removal & Services</span>
          </h2>
          <p className="text-xl text-gray-300">
            Same-day junk hauling, dumpster rental, demolition & skid steer services in Waxahachie, TX.
          </p>
        </div>
